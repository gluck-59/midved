...
<!--                        <select id="customers" data-live-search="true" title="От кого платеж?"></select>-->
			...
			<div id="modalAutoDistributionReport" class="modal-body">
                ...
                <div class="alert alert-info" role="alert">
                    ...
                    <p>Прежде всего корректируется самые старые заявки с отрицательным балансом (в рамках указанного клиента) и статусом, отличным от «<?=RequestModel::STATUSES[2]?>». </p>
                </div>
                <div class="alert alert-info" role="alert">
