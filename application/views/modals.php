		...
		<div class="modal-content">
			...
			<div id="modalAutoDistributionReport" class="modal-body">
                <div class="alert alert-info" role="alert">
                    <p>Цель автоматической разноски платежа — взять незакрытые заявки с отрицательным балансом и довести баланс до 0.</p>
                    ...
                    <p> Заявка с нулевым балансом считается полностью оплаченной.</p>
                </div>
