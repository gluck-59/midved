		...
		<div class="row">
			<div class="col-md-2">
				<div class="btn-block">
					...
					<button disabled type="button" class="btn btn-warning btn-lg btn-block btn-open-modal"  data-toggle="modal" data-target="#modal-payment">Новый приход</button>
					<button disabled type="button" class="btn btn-danger btn-lg btn-block btn-open-modal"  data-toggle="modal" data-target="#modal-payment">Новый расход</button>
